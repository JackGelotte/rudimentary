...
axios.CanceledError = __webpack_require__(24);
axios.CancelToken = __webpack_require__(69);
axios.isCancel = __webpack_require__(66);
axios.VERSION = (__webpack_require__(45).version);
axios.toFormData = __webpack_require__(15);

// Expose AxiosError class
axios.AxiosError = __webpack_require__(13);
...
// Expose isAxiosError
axios.isAxiosError = __webpack_require__(71);
...
var validator = __webpack_require__(68);
...
var defaults = __webpack_require__(11);
var CanceledError = __webpack_require__(24);
...
var AxiosError = __webpack_require__(13);
var transitionalDefaults = __webpack_require__(14);
...
var defaults = {
  ...
  env: {
    FormData: __webpack_require__(46)
  },
...
var AxiosError = __webpack_require__(13);
var CanceledError = __webpack_require__(24);
var parseProtocol = __webpack_require__(25);
...
var mime = __webpack_require__(52);
var asynckit = __webpack_require__(55);
var populate = __webpack_require__(65);
...
var util = __webpack_require__(40);
var Stream = (__webpack_require__(31).Stream);
var DelayedStream = __webpack_require__(49);
...
var db = __webpack_require__(53)
var extname = (__webpack_require__(50).extname)
...
module.exports =
{
  parallel      : __webpack_require__(56),
  serial        : __webpack_require__(63),
  serialOrdered : __webpack_require__(64)
};
...
var defer = __webpack_require__(59);
...
var serialOrdered = __webpack_require__(64);
...
let rudiStatusBarItem;
function activate(context) {
    // Första testet. Detta ska vid kommando visa ett skämt.
    const rudiJoke = vscode.commands.registerCommand("rudimentary.joke", async () => {
    ...
    rudiStatusBarItem = vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Right);
    rudiStatusBarItem.command = "rudimentary.reminder";
    updateStatusBarItem();
    // Den viktiga delen. Detta är Rudimentary's reminder.
    let rudiRemRef;
    const rudiReminder = vscode.commands.registerCommand("rudimentary.reminder", async () => {
        let message = "You should take a break. You've been at it for 25 min.";
        let time = 1500000;
    ...
    const rudiRemoveReminder = vscode.commands.registerCommand("rudimentary.removeReminder", () => {
    ...
    const rudiCreateRudiFile = vscode.commands.registerCommand("rudimentary.createRudiFile", async () => {
    ...
    const rudiSnippet = vscode.languages.registerCompletionItemProvider("plaintext", {
        provideCompletionItems(document, position, token, context) {
            // Snippet som gör en RegEx som matchar på ordet cool.
            const snippetCompletion = new vscode.CompletionItem("RegEx");
            snippetCompletion.insertText = new vscode.SnippetString("const regex = new regex(/(?i)(cool)/);");
            const docs = new vscode.MarkdownString('Adds simple regex which matches against the word "cool".');
    ...
    context.subscriptions.push(rudiJoke, rudiReminder, rudiRemoveReminder, rudiCreateRudiFile, rudiSnippet, rudiStatusBarItem);
}
